...
export class User extends BaseEntity {
    ...
    @OneToMany(
        () => LandingPages,
        (landingPages) => landingPages.createByUser
    )
    createLandingPage: LandingPages[];

    @OneToMany(
        () => LandingPages,
        (landingPages) => landingPages.updateByUser
    )
    updateLandingPage: LandingPages[];
    ...
    @ManyToOne(
        () => LandingPages,
        (landingPages) => landingPages.refferalUsers
    )
