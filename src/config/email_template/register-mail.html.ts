...
export function RagisterMail(param = '')
{
                                ...
                                <tr>
                                    <td align="center" valine="top" style="padding: 10px 15px 30px; background: #ffffff;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%">
                                            <tbody>
                                                <tr>
                                                    <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif;font-size: 22px; line-height: 24px; color: #444444;padding-top: 20px; text-align: center; font-weight: 700;">Welcome to Laytrip <span style="font-style: italic;">Josh!</span></td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <img style="width:40px; height:40px;" src="Images/flight.png" alt="Flight">
                                                                </a>
                                                                </td>
                                                                <td width="15" style="width:15px;"></td>
                                                                <td>
                                                                    <a href="javascrip:void(0);" target="_blank" style="text-decoration:none;">
                                                                    <img style="width:40px; height:40px;" src="Images/hotel.png" alt="Flight">
                                                                </a>
                                                                </td>
                                                                <td width="15" style="width:15px;"></td>
                                                                <td>
                                                                    <a href="javascrip:void(0);" target="_blank" style="text-decoration:none;">
                                                                    <img style="width:40px; height:40px;" src="Images/vacation-rental.png" alt="Flight">
                                                                </a>
                                                                </td>
                                                            </tr>
                                                        </table>
