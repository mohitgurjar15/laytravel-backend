                                    ...
                                    <td align="center" valine="top" style="padding: 10px 15px 30px; background: #ffffff;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif;font-size: 14px; line-height: 18px; color: #000;padding-top: 15px; text-align: center;">Per your request to reset your password, your One Time Pin is <span style="font-weight:bold; color:black",> ${param.otp}</span>. When prompted by the platform enter this OTP, which will be valid for the next (INSERT TIME) minutes. </td>
                                                </tr>
                                                <tr>
