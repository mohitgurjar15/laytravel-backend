...
export function InquiryAutoReplayMail(param:{ username:string })
{
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    Thank you for contacting Laytrip Customer Service. A member of our team will get back to you within 24 hours.                                                     </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
