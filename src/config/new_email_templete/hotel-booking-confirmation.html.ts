...
import { HotelBookingEmailParameterModel } from "../email_template/model/hotel-booking-email.model";
import { LaytripFooter } from "./laytrip_footer.html";
import { LaytripHeader } from "./laytrip_header.html";

export async function LaytripHotelBookingConfirmtionMail(
                    ...
                    >
                        ...
                        >
                            <span style="color: #000000">Hotel:</span> ${
                                param.hotelData.hotelName
                            }, Check-in ${DateTime.convertDateFormat(
        param.hotelData.checkIn,
        "YYYY-MM-DD",
        "MMMM DD, YYYY"
    )}, ${param.hotelData.room} Room 
                            ${
                                param.hotelData.adult
                                    ? ", " + param.hotelData.adult + " Adult"
                                    : ""
                            }
                            ${
                                param.hotelData.child
                                    ? ", " + param.hotelData.child + " Child"
                                    : ""
                            }
                            </td>
                    </tr>`;
