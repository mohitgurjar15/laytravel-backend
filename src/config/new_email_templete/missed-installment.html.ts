...
export function LaytripMissedPaymentTemplete(param: {
  ...
  let content = `<tr>
    <td align="center" valine="top" style="padding: 20px 25px 10px; background: #ffffff;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%">
            <tbody>
                <tr>
                    <td align="left" valign="top" style="font-family: 'Poppins', sans-serif;font-size: 18px; line-height: 20px; color: #000000;padding:0 0 20px 0; text-align: left;"> Hi ${param.userName},</td>
                </tr>
                `;
  if (param.try == 2) {
    content += `<tr>
                    <td align="left" valign="top" style="font-family: 'Poppins', sans-serif;font-size: 18px; line-height: 20px; color: #707070;padding:0 0 20px 0; text-align: left;">2nd Notice!`;
  }
  if (param.try == 3) {
    content += `<tr>
                    <td align="left" valign="top" style="font-family: 'Poppins', sans-serif;font-size: 18px; line-height: 20px; color: #707070;padding:0 0 20px 0; text-align: left;">3rd and final missed payment notice!</td>
                     </tr>`;
  }
  content += `
                <tr>
                    <td align="left" valign="top" style="font-family: 'Poppins', sans-serif;font-size: 18px; line-height: 20px; color: #707070;padding:0 0 20px 0; text-align: left;">We’re ${
                      param.try > 1 ? "still" : ""
  ...
  if (param.try < 3) {
    content += `<tr>
                    <td align="left" valign="top" style="font-family: 'Poppins', sans-serif;font-size: 18px; line-height: 20px; color: #707070;padding:0 0 20px 0; text-align: left;">${
