...
export async function CartLessChargeMail(
                ...
                <tr>
                 ...
                 <tr>
                    <td align="left" valign="top"
                       ...
                       We are sorry, but due to a technical issue, your card has been undercharged by ${param.priceDifferance}. Our customer service department has already been notified and the extra amount will be taken from your card within 3-5 business days.
