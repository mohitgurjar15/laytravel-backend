...
export async function LaytripFlightReminderMail(
    ...
    //         //                                         droup.flight
    //         //                                     }</span>
    //         //                                     <span style="display: block;">${droup.airline ||
    //         //                                         ""}</span>
    //         //                                 </td>
    //         //                             </tr>
    //         //                         </table>
    ...
    content += ` <tr>
                    <td style="padding: 15px 0;">
                        <table class="oc_wrapper" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="center" valign="middle" style="font-family: 'Open Sans', sans-serif; font-size: 18px; font-weight: bold; " height="48">
                ...
                <tr>
                    <td align="left" valign="top"
                        ...
                        style="color: #0c7bff;"><u>customerservice@laytrip.com</u></a> with questions. We hope you have a great trip!
                    </td>
                </tr>
            </tbody>
        </table>
