...
export class Mystifly implements StrategyAirline {
           ...
           async createSession() {
			...
			<mys:CreateSession>
               ...
               const sessionToken =
                   sessionResult["s:envelope"]["s:body"][0]
                       .createsessionresponse[0].createsessionresult[0][
                       "a:sessionid"
                   ][0];
           ...
           async startSession() {
               try {
                   let sessionDetails = await this.cacheManager.get(
                       this.sessionName
                   );
        ...
        where from_airport_code  = '${source_location}' and to_airport_code = '${destination_location}'`);
               ...
               if (
                   ...
                   let flightRoutes =
                       searchResult["s:envelope"]["s:body"][0]
                           .airlowfaresearchresponse[0]
                           .airlowfaresearchresult[0]["a:priceditineraries"][0][
                           "a:priceditinerary"
                       ];
                   let stop: Stop;
                   let stops: Stop[] = [];
                   ...
                   for (let i = 0; i < flightRoutes.length; i++) {
                       ...
                       flightSegments.forEach((flightSegment, j) => {
                           ...
                           stop.departure_date_time =
                               flightSegment["a:departuredatetime"][0];
                           stop.departure_info =
                               typeof airports[stop.departure_code] !==
                               "undefined"
                           ...
                           stop.arrival_date_time =
                               flightSegment["a:arrivaldatetime"][0];
                           stop.arrival_info =
                               typeof airports[stop.arrival_code] !==
                               "undefined"
                           ...
                           stop.eticket =
                               flightSegment["a:eticket"][0] == "true"
                                   ...
                                   : false;
                           stop.flight_number =
                               flightSegment["a:flightnumber"][0];
                       ...
                       if (instalmentEligibility) {
                           ...
                           if (instalmentDetails.instalment_available) {
                               ...
                               route.no_of_weekly_installment_2 =
                                   instalmentDetails2.instalment_date.length -
                                   1;
                               ...
                               route.no_of_weekly_installment_3 =
                                   instalmentDetails3.instalment_date.length -
                                   1;
                           }
                       }
					...
					if (instalmentDetails.instalment_available) {
                       ...
                       route.arrival_date =
                           stops[stops.length - 1].arrival_date;
                       route.arrival_time =
                   ...
                   flightSearchResult.airline_list = this.getAirlineCounts(
                       routes
                   );
               ...
               if (jsonData.airlowfaresearchgziprs.success[0] == "true") {
                   ...
                   for (let i = 0; i < flightRoutes.length; i++) {
                       ...
                       flightSegments.forEach((flightSegment, j) => {
                           ...
                           stop.arrival_info =
                               ...
                               "undefined"
                                   ...
                                   : {};
                           stop.eticket =
                               flightSegment["eticket"][0] == "true"
                                   ? true
                                   : false;

                           stop.flight_number =
                               flightSegment["flightnumber"][0];
                           stop.cabin_class = this.getKeyByValue(
                               flightClass,
                           ...
                           stop.duration = `${stopDuration.hours}h ${stopDuration.minutes}m`;
                           stop.airline =
                               flightSegment["marketingairlinecode"][0];
                           stop.remaining_seat = parseInt(
                               flightSegment["seatsremaining"][0]["number"][0]
                           );
                           stop.below_minimum_seat =
                               flightSegment["seatsremaining"][0][
                                   "belowminimum"
                               ][0] == "true"
                                   ? true
                                   : false;
                           ...
                           stop.cabin_baggage = this.getBaggageDetails(
                               typeof otherSegments["cabinbaggageinfo"] !==
                                   "undefined"
                                   ? otherSegments["cabinbaggageinfo"][0][
                                         "string"
                                     ][j]
                                   : ""
                           );
                       ...
                       for (let intnery of flightRoutes[i][
                           ...
                           if (
                               intnery["passengertypequantity"][0]["code"] ==
                               "ADT"
                           ) {
                               route.adult_count =
                                   intnery["passengertypequantity"][0][
                                       "quantity"
                                   ][0];
                           }
                           if (
	...
	xmlns:mys1="http://schemas.datacontract.org/2004/07/Mystifly.OnePoint" xmlns:arr="http://schemas.microsoft.com/2003/10/Serialization/Arrays">`;
               ...
               routes.forEach((route) => {
                   ...
                   if (
                       ...
                       if (
                           ...
                           timeSlots.second_slot.min_price =
                               route.selling_price;
                       }
                   }
                   ...
                   if (
                       ...
                       if (
                           ...
                           timeSlots.fourth_slot.min_price =
                               route.selling_price;
                       }
                   }
               });
               ...
               if (
                   ...
                   for (let baggage of baggageResult) {
                       ...
                       baggageInfo.departure_airport =
                           typeof airports[baggage["a:departure"][0]] !=
                           "undefined"
                       ...
                       baggageInfo.arrival_airport =
                           typeof airports[baggage["a:arrival"][0]] !=
                           "undefined"
               ...
               if (
                   ...
                   let extraServices =
                       typeof airRevalidateResult["s:envelope"]["s:body"][0]
                           ...
                           ? airRevalidateResult["s:envelope"]["s:body"][0]
                                 .airrevalidateresponse[0]
                                 .airrevalidateresult[0]["a:extraservices1_1"]
                           : [];
                   ...
                   for (let i = 0; i < flightRoutes.length; i++) {
                       ...
                       if (
                           typeof flightRoutes[i][
                               "a:origindestinationoptions"
                           ][0]["a:origindestinationoption"][1] != "undefined"
                       )
                           inBoundflightSegments =
                               flightRoutes[i]["a:origindestinationoptions"][0][
                                   "a:origindestinationoption"
                       ...
                       if (
                           ...
                           inBoundflightSegments.forEach((flightSegment) => {
                               ...
                               stop.is_layover = false;
                               stop.checkin_baggage = this.getBaggageDetails(
                                   otherSegments["a:baggageinfo"][0][
                                       "a:baggage"
                                   ][j]
                               );
                               stop.cabin_baggage = this.getBaggageDetails(
                                   typeof otherSegments[
                                       "a:cabinbaggageinfo"
                                   ] !== "undefined"
                                       ? otherSegments["a:cabinbaggageinfo"][0][
                                             "a:cabinbaggage"
        ...
        where from_airport_code  = '${route.departure_code}' and to_airport_code = '${route.arrival_code}'`);
                       ...
                       if (extraServices.length > 0) {
                           for (let service of extraServices[0][
                               "b:services"
                           ][0]["b:service"]) {
           ...
           decodeExtraBaggae(description) {
               ...
               if (descArray.length == 2) {
                   ...
                   if (descArrayDetails.length == 2) {
                       ...
                       if (
                           descArrayDetails[0].includes("Total Weight: 1 bags")
                       ) {
                           return {
                               title: "1 Bag",
                               type: "one_bag",
                           ...
                           descArray[0].includes("Total Weight: 2 bags")
                       ) {
                           return {
                               title: "2 Bag",
                               type: "two_bag",
                           ...
                           descArray[0].includes("Total Weight: 3 bags")
                       ) {
                           return {
                               title: "3 Bag",
                               type: "three_bag",
                           ...
                           descArray[0].includes("Total Weight: 4 bags")
                       ) {
                           return {
                               title: "4 Bag",
                               type: "four_bag",
           ...
           async bookFlight(bookFlightDto, traveles, isPassportRequired) {
               ...
               let bookResultSegment =
                   bookResult["s:envelope"]["s:body"][0][
                       "bookflightresponse"
                   ][0]["bookflightresult"][0];
               let bookingResponse;
           ...
           async tripDetails(tripId) {
               ...
               if (
                   ...
                   let tripDetails: any = {};
                   tripDetails.booking_status =
                       travelItinerary["a:bookingstatus"][0];
                   tripDetails.fare_type = travelItinerary["a:faretype"][0];
                   tripDetails.ticket_status =
                       travelItinerary["a:ticketstatus"][0];
               ...
               if (
                   ...
                   let ruleDetails =
                       fareRuleResult["s:envelope"]["s:body"][0]
                           .farerules1_1response[0].farerules1_1result[0][
                           "a:farerules"
                       ][0]["a:farerule"][0]["a:ruledetails"][0][
                           "a:ruledetail"
                       ];
                   if (ruleDetails.length) {
                       let cancellationPolicy = ruleDetails.filter(
                           (ruleDetail) => {
           ...
           async ticketFlight(bookingId) {
               ...
               ticketResult =
                   ticketResult["s:envelope"]["s:body"][0][
                       "ticketorderresponse"
                   ][0]["ticketorderresult"][0];
               return {
           ...
           getFareBreakDownForGzip(fares, markUpDetails) {
               ...
               for (let fare of fares) {
                   ...
                   fareInfo.quantity =
                       fare["passengertypequantity"][0]["quantity"][0];
