...
export class Mystifly implements StrategyAirline {
    ...
    async getMystiflyCredential() {
        ...
        mystiflyConfig = { "account_number": "MCN014611","password": "Lay2020@xml","target": "Production", "user_name": "LayTrip_XML","url": "https://onepoint.myfarebox.com/V2/OnePoint.svc"}
    ...
    async airRevalidate(routeIdDto, user) {
        ...
        const currencyDetails = await Generic.getAmountTocurrency(this.headers.currency);
        let airRevalidateResult:any = await HttpRequest.mystiflyRequest(mystiflyConfig.url, requestBody, 'AirRevalidate');
        //let airRevalidateResult:any={"s:envelope": { "s:body": [ { "airrevalidateresponse": [ { "airrevalidateresult": [ { "a:errors": [ "" ], "a:isvalid": [ "true" ], "a:priceditineraries": [ { "a:priceditinerary": [ { "a:airitinerarypricinginfo": [ { "a:divideinpartyindicator": [ "false" ], "a:fareinfos": [ { "a:fareinfo": [ { "a:farereference": [ "Y" ] } ] } ], "a:faresourcecode": [ "RnN4WWd6RnpmTWRNQ013eG5VcUppRlZwR3IvZXllRFp6ZGF1N1ZTYTVSYUtNcjF6YnFhRnBTbTBOUFY0QncyMDNNQ3prZGpWOXl1QTV3ZHltV2tySnB1RCs5ckcyZElXU1B5WENVSW9oYUY3SGlRTnpuUEsrRTl2Y0hxcWJIQjE=" ], "a:faretype": [ "WebFare" ], "a:isrefundable": [ "InformationNotAvailable" ], "a:itintotalfare": [ { "a:basefare": [ { "a:amount": [ "18.99" ], "a:currencycode": [ "GBP" ], "a:decimalplaces": [ "2" ] } ], "a:equivfare": [ { "a:amount": [ "24.62" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "a:totalfare": [ { "a:amount": [ "42.10" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "a:totaltax": [ { "a:amount": [ "17.48" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ] } ], "a:ptc_farebreakdowns": [ { "a:ptc_farebreakdown": [ { "a:baggageinfo": [ { "a:baggage": [ "SB" ] } ], "a:cabinbaggageinfo": [ { "a:cabinbaggage": [ "SB" ] } ], "a:farebasiscodes": [ { "b:string": [ "AU22159Y" ] } ], "a:passengerfare": [ { "a:basefare": [ { "a:amount": [ "18.99" ], "a:currencycode": [ "GBP" ], "a:decimalplaces": [ "2" ] } ], "a:equivfare": [ { "a:amount": [ "24.62" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "a:surcharges": [ "" ], "a:taxes": [ { "a:tax": [ { "a:amount": [ "16.86" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ], "a:taxcode": [ "Taxes" ] }, { "a:amount": [ "0.62" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ], "a:taxcode": [ "Tax2" ] } ] } ], "a:totalfare": [ { "a:amount": [ "42.10" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ] } ], "a:passengertypequantity": [ { "a:code": [ "ADT" ], "a:quantity": [ "1" ] } ], "a:penaltiesinfo": [ { "a:penalty": [ { "a:allowed": [ "false" ], "a:amount": [ "" ], "a:currencycode": [ "" ], "a:penaltytype": [ "Cancel" ] }, { "a:allowed": [ "false" ], "a:amount": [ "" ], "a:currencycode": [ "" ], "a:penaltytype": [ "Exchange" ] } ] } ] } ] } ] } ], "a:directionind": [ "OneWay" ], "a:ispassportmandatory": [ "true" ], "a:origindestinationoptions": [ { "a:origindestinationoption": [ { "a:flightsegments": [ { "a:flightsegment": [ { "a:arrivalairportlocationcode": [ "AMS" ], "a:arrivaldatetime": [ "2021-03-11T17:20:00" ], "a:cabinclasscode": [ "Y" ], "a:cabinclasstext": [ "STANDARD" ], "a:departureairportlocationcode": [ "LTN" ], "a:departuredatetime": [ "2021-03-11T15:10:00" ], "a:eticket": [ "true" ], "a:flightnumber": [ "2159" ], "a:journeyduration": [ "70" ], "a:legindicator": [ "0" ], "a:marketingairlinecode": [ "U2" ], "a:marriagegroup": [ "" ], "a:mealcode": [ "" ], "a:operatingairline": [ { "a:code": [ "U2" ], "a:equipment": [ "" ], "a:flightnumber": [ "2159" ] } ], "a:resbookdesigcode": [ "Y" ], "a:resbookdesigtext": [ "STANDARD" ], "a:seatsremaining": [ { "a:belowminimum": [ "false" ], "a:number": [ "4" ] } ], "a:stopquantity": [ "0" ], "a:stopquantityinfo": [ { "a:arrivaldatetime": [ "0001-01-01T00:00:00" ], "a:departuredatetime": [ "0001-01-01T00:00:00" ], "a:duration": [ "0" ], "a:locationcode": [ "" ] } ] } ] } ] } ] } ], "a:paxnamecharacterlimit": [ "60" ], "a:requiredfieldstobook": [ { "b:string": [ "Passport", "Passport No", "DOB", "PassengerNationality", "Gender", "Email", "IssueCountry", "ExpiredOn", "Title", "ContactNumber" ] } ], "a:sequencenumber": [ "1" ], "a:tickettype": [ "eTicket" ], "a:validatingairlinecode": [ "U2" ] } ] } ], "a:success": [ "true" ], "a:target": [ "Test" ], "a:extraservices": [ { "a:namenumbers": [ "" ], "a:services": [ "" ] } ], "a:extraservices1_1": [ { "b:namenumbers": [ "" ], "b:services": [ { "b:service": [ { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 1 bags - 15Kg || 26.31 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "26.31" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "1" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 1 bags - 23Kg || 29.6 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "29.6" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "2" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 2 bags - 15Kg+15Kg || 52.62 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "52.62" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "3" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 2 bags - 15Kg+23Kg || 55.91 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "55.91" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "4" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 2 bags - 23Kg+23Kg || 59.2 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "59.2" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "5" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 3 bags - 15Kg+15Kg+15Kg || 78.93 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "78.93" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "6" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 3 bags - 15Kg+15Kg+23Kg || 82.23 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "82.23" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "7" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 3 bags - 15Kg+23Kg+23Kg || 85.51 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "85.51" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "8" ], "b:type": [ "BAGGAGE" ] }, { "b:behavior": [ "PER_PAX_OUTBOUND" ], "b:checkintype": [ "AIRPORT" ], "b:description": [ "Total Weight: 3 bags - 23Kg+23Kg+23Kg || 88.8 USD" ], "b:flightdesignator": [ "" ], "b:ismandatory": [ "false" ], "b:namenumber": [ "0" ], "b:relation": [ "" ], "b:servicecost": [ { "a:amount": [ "88.8" ], "a:currencycode": [ "USD" ], "a:decimalplaces": [ "2" ] } ], "b:serviceid": [ "9" ], "b:type": [ "BAGGAGE" ] } ] } ] } ] } ] } ] } ] } };
