...
export class Strategy {
    ...
    async roundTripSearchZip(param1, param2,param3,param4,param5,param6) {

        const data = await this.airline.roundTripSearchZip(param1, param2,param3,param4,param5,param6);
        return data;
    }
