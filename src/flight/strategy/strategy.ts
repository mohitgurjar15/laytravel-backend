...
export class Strategy {
    ...
    async roundTripSearch(param1, param2, param3) {
        const data = await this.airline.roundTripSearch(param1, param2, param3);
        return data;
    }
    ...
    async airRevalidate(param1, param2, param3) {
        const data = await this.airline.airRevalidate(param1, param2, param3);
        return data;
    }
