...
export class AuthController {
    ...
    signUp(
        ...
        return this.authService.signUp(createUser, req,referralId);
    }
    ...
    async updatePassword(
        ...
        return this.authService.updatePassword(newPasswordDto,referralId);
    }
    ...
    async verifyOtp(
        ...
        return this.authService.VerifyOtp(otpDto, req, siteUrl,referralId);
    }
    ...
    async resendOtp(
        ...
        return this.authService.resendOtp(reSendVerifyoOtpDto, referralId);
    }
    ...
    async updateAppleUser(
        ...
        return await this.authService.updateAppleUser(
            updateAppleUserDto,
            user,
            siteUrl
        );
